...
public class CommonConfig {
	...
	public CommonConfig(ForgeConfigSpec.Builder builder) {
		...
		this.availableEmbedSortByTier = builder.comment("Sort Devil Fruits by Alphabet").define("Sort by Alphabet", false);
		...
		this.unavailableEmbedSortByTier = builder.comment("Sort Devil Fruits by Alphabet").define("Sort by Alphabet", false);
	...
	public ForgeConfigSpec.BooleanValue getShowAvailableEmbed() {
		return showAvailableEmbed;
	}

	public ForgeConfigSpec.BooleanValue getShowUnavailableEmbed() {
		return showUnavailableEmbed;
	}

	public ForgeConfigSpec.LongValue getAvailableChannelId() {
		return availableChannelId;
	}

	public ForgeConfigSpec.LongValue getUnavailableChannelId() {
		return unavailableChannelId;
	}

	public ForgeConfigSpec.BooleanValue getShowStatus() {
		return showStatus;
	}

	public ForgeConfigSpec.BooleanValue getShowPlayerNameAsStatus() {
		return showPlayerNameAsStatus;
	}

	public ForgeConfigSpec.BooleanValue getUseEmojis() {
		return useEmojis;
	}

	public ForgeConfigSpec.ConfigValue<String> getAvailableEmbedColor() {
		return availableEmbedColor;
	}

	public ForgeConfigSpec.ConfigValue<String> getAvailableEmbedFooter() {
		return availableEmbedFooter;
	}

	public ForgeConfigSpec.BooleanValue getAvailableEmbedShowLastUpdated() {
		return availableEmbedShowLastUpdated;
	}

	public ForgeConfigSpec.BooleanValue getAvailableEmbedSortByTier() {
		return availableEmbedSortByTier;
	}

	public ForgeConfigSpec.BooleanValue getAvailableEmbedSortByAlphabet() {
		return availableEmbedSortByAlphabet;
	}

	public ForgeConfigSpec.ConfigValue<String> getUnavailableEmbedColor() {
		return unavailableEmbedColor;
	}

	public ForgeConfigSpec.ConfigValue<String> getUnavailableEmbedFooter() {
		return unavailableEmbedFooter;
	}

	public ForgeConfigSpec.BooleanValue getUnavailableEmbedShowLastUpdated() {
		return unavailableEmbedShowLastUpdated;
	}

	public ForgeConfigSpec.BooleanValue getUnavailableEmbedSortByTier() {
		return unavailableEmbedSortByTier;
	}

	public ForgeConfigSpec.BooleanValue getUnavailableEmbedSortByAlphabet() {
		return unavailableEmbedSortByAlphabet;
	}
}
